...
- `tools/check.js`, 24 checks covering the store, the CLI, the renderer, the config reader, the Claude Code payload mapping, and what setup writes outside the plugin.
